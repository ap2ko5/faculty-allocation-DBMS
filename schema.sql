-- SQL Schema for the Faculty Allocation System
-- This script creates all the necessary tables for the application.

-- Drop tables and types if they exist to start fresh (useful during development)
...
-- Passwords for all teachers is 'password123'. The hash is a valid bcrypt hash.
INSERT INTO teachers (name, email, password_hash, department, expertise, max_load) VALUES
('Dr. Evelyn Reed', 'evelyn.reed@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Computer Science', 'AI, Machine Learning', 12),
('Prof. Samuel Tan', 'samuel.tan@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Electronics', 'Embedded Systems, VLSI', 10),
('Dr. Priya Sharma', 'priya.sharma@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Computer Science', 'Databases, Web Development', 14);
